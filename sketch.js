...
function setup() {
	...
	stick1 = new Stick(300, 100, 50, 20);
	World.add(world, stick1);

	stick2 = new Stick(350, 100, 50, 20);
	World.add(world, stick1);

	stick3 = new Stick(400, 100, 50, 20);
	World.add(world, stick1);

	stick4 = new Stick(450, 100, 50, 20);
	World.add(world, stick1);

	stick5 = new Stick(500, 100, 50, 20);
	World.add(world, stick1);
